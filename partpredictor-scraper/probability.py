...
def probability_scrape(brand_starting_index=0, brand_batch_size=None, model_starting_index=0, issue_starting_index=-1):
...
if __name__ == "__main__":
    brand_starting_index = -1
    model_starting_index = -1
    ...
    print(f"---> BRAND {brand_starting_index}")
    print(f"---> MODEL {model_starting_index}")
    probability_scrape(brand_starting_index=brand_starting_index, model_starting_index=model_starting_index)
